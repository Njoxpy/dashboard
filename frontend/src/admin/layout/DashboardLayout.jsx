...
import DashboardLoading from "../components/DashboardLoading"; // Import your loading component
import {
  ChevronDown,
  Menu,
  User,
...
const DashboardLayout = () => {
  ...
  // Simulate loading data (e.g., waiting for API calls, etc.)
  useEffect(() => {
    setTimeout(() => {
      setLoading(false); // Stop loading after 3 seconds
    }, 3000); // Adjust timing as necessary (you may want to wait for actual data fetching)
  }, []);
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      {/* Show Loading if the content is still being loaded */}
      {loading ? (
        <DashboardLoading /> // Display the loading component
      ) : (
        <>
          {/* Overlay for mobile */}
          {open && (
